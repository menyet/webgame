...
define("DB_USER","root");		// uzivatel databazy
define("DB_PASSWORD","login");	// heslo na prihlasenie k DB
define("DB_NAME","wasteland");		// meno databazy
define('URL', 'http://localhost/andris/wasteland/'); // URL stranky */
...
define("DB_PASSWORD","wasteland");	// heslo na prihlasenie k DB
...
require_once('classes/places/placemanager.php');
