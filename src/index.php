	...
	class Wasteland {
      ...
      if (isset($_GET['action']) && ($_GET['action']=='logout')){
		...
		private function notloggedin() {
		  ...
		  if ($action == 'story') {			// ak $action je 'story', tak vytvori triedu STORY_PAGE
        require 'classes/class_story_page.php';
        $son = new STORY_PAGE(); 
		  } elseif ($action == 'manual') {	// ak $action je 'manual', tak  vytvori triedu MANUAL_PAGE
        require 'classes/class_manual_page.php';
        $son = new MANUAL_PAGE(); 
		  } elseif ($action == 'top') {	// ak $action je 'top', tak  vytvori triedu TOP_PAGE
		...
		private function prepareLocation() {
			if (isset($_GET['action']) && ($_GET['action'] == 'begindialogue')) {
